...
export const studioSections: StudioSection[] = [
  ...
  },
  {
    ...
    accent: "cyan",
    icon: Boxes,
    actions: ["Nuevo proyecto"],
  },
  {
    id: "certificates",
    title: "Certificados",
    eyebrow: "Formacion",
    description: "Administra PDFs, imagenes originales, emisores, fechas, etiquetas y visor verificable.",
    metric: "4 archivos",
    detail: "PDF e imagen local en public/certificados",
    accent: "violet",
    icon: FileBadge2,
